...
From **[C1](C1-what-is-data-leakage.qmd)** and **[C2](C2-why-most-ml-pipelines-are-unsafe-by-default.qmd)**, recall the following points:
...
From **[C3](C3-guarded-resampling.qmd)**, recall:
...
From **[C4](C4-what-fastml-does-not-allow.qmd)**, recall:
